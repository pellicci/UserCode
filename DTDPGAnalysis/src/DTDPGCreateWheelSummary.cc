...
// ==========================================================================================================
 ...
 for(int iw=0;iw<5;iw++)
 {
   ...
   for(int isec=1;isec<13;isec++)
   {
      ...
      QualBestDCCSec[iw][isec-1]->GetXaxis()->SetLabelSize(0.12);
 ...
 for(int iw=0;iw<5;iw++)
 {
   ...
   for(int isec=1;isec<13;isec++)
   {
      ...
      QualBX0DCCSec[iw][isec-1]->GetXaxis()->SetLabelSize(0.12);
 ...
 for(int ins=1;ins<13;ins++)
 {
   ...
   for(int iw=1;iw<5;iw++)
   {
    ...
    for(int iw=0;iw<5;iw++)
    {
      ...
      QualBX0DCCSec[iw][ins-1]->GetXaxis()->SetLabelSize(0.12);
