...
foreach $tclfile (@LIST) {
  ...
  print OUTFILE "# === This file was generated automatically by enerateTcl_BToKKKL_style.pl of PhKUser package \n";
  ...
  print OUTFILE "sourceFoundFile K0LUser/MCK0LRecoDs_KplusKzero.tcl \n";
  close (OUTFILE);
  system ("\mv out.txt dsccbarMCtcl/$barefile.tcl");
  system ("\rm out.txt");
}
...
sub help(){
  ...
  print "generateTcl_BToKKKL_style.pl tcl1, tcl2, ... tcln \n";
  print "or:\n";
  print "generateTcl_BToKKKL_style.pl -d tcldir/ \n";
