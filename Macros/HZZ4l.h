...
public:
  ...
  void setVHsplit(bool vhsplit){doVHsplit=vhsplit;}
...
private:
  ...
  void getWeightFromFile(const std::string mPOLE, const Bool_t is8TeV, const Bool_t isVBF, const Bool_t isNewHighmass);
