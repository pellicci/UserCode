...
poimin = poi.find("Npsi").getMin()
poimax = poi.find("Npsi").getMax()
...
print "Bayesian upper limit on Npsi = ", bcInterval.UpperLimit()

#Plot now the result of the scan 

#First the CLs
freq_plot = ROOT.RooStats.HypoTestInverterPlot("HTI_Result_Plot","Frequentist scan result for Npsi",result)
